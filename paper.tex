...
\author{George Stelle\inst{1} \and Darko Stefanovic\inst{1} 
...
%In addition, we implement a simple compiler that targets native code and show
%that it has reasonable performance despite some significant
